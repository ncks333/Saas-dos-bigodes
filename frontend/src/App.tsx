...
const SignupPage=lazy(()=>import("./BillingPages").then(module=>({default:module.SignupPage})));
const RegularizationPage=lazy(()=>import("./BillingPages").then(module=>({default:module.RegularizationPage})));
const CheckoutStatusPage=lazy(()=>import("./BillingPages").then(module=>({default:module.CheckoutStatusPage})));
...
export default function App(){
  ...
  else if(path==="/cadastro")page=<SignupPage/>;
  ...
  else if(path==="/regularizar")page=<RegularizationPage/>;
  else if(path==="/checkout/concluido"||path==="/checkout/cancelado"||path==="/checkout/expirado")page=<CheckoutStatusPage path={path}/>;

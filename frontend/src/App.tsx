...
function PublicBooking({slug}:{slug:string}) {
  ...
  if(booking.isSuccess)return <main className="public-shell"><section className="success-card"><div className="success-icon"><CalendarDays/></div><p className="eyebrow">Tudo certo</p><h1>Horário solicitado!</h1><p>Seu pedido foi registrado. Você receberá a confirmação pelo WhatsApp.</p><Button onClick={()=>location.reload()}>Fazer outro agendamento</Button></section></main>;

...
class Migration(migrations.Migration):
    ...
    operations = [migrations.CreateModel(name="Service", fields=[
    ...
    ], options={"constraints": [models.UniqueConstraint(fields=("barbershop", "name"), name="unique_service_name_per_tenant")]})]
